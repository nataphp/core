 ...
 * Created when you call OptionParser::addSubcommand()
 *
 * @see \Nata\Console\OptionParser::addSubcommand()
 */
class InputSubCommand {
...
/**
 * The OptionParser for this subcommand.
 *
 * @var \Nata\Console\OptionParser|null
 */
    protected $_parser;
 ...
 * @param \Nata\Console\OptionParser|array<string, mixed>|null $parser A parser for this subcommand.
 *   Either a OptionParser, or an array that can be used with OptionParser::buildFromArray().
 */
    public function __construct($name, $help = '', $parser = null) {
        ...
        if (is_array($parser)) {
            $parser['command'] = $name;
            $parser = OptionParser::buildFromArray($parser);
        }
 ...
 *
 * @return \Nata\Console\OptionParser|null
 */
