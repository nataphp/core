 ...
 * See CronOutput::styles() to learn more about defining your own styles.  Nested styles are not supported
 * at this time.
 */
...
/**
 * The current output type. Manipulated with CronOutput::outputAs();
 *
 * @var integer.
 */
 ...
 * You can modify these styles with CronOutput::styles()
 *
 * @var array
 */
