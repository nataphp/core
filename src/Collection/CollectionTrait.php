 ...
 */
namespace Nata\Collection;

use AppendIterator;
use ArrayIterator;
use Nata\Collection\Iterator\BufferedIterator;
use Nata\Collection\Iterator\ExtractIterator;
use Nata\Collection\Iterator\FilterIterator;
use Nata\Collection\Iterator\InsertIterator;
use Nata\Collection\Iterator\MapReduce;
use Nata\Collection\Iterator\NestIterator;
use Nata\Collection\Iterator\ReplaceIterator;
use Nata\Collection\Iterator\SortIterator;
use Nata\Collection\Iterator\StoppableIterator;
use Nata\Collection\Iterator\TreeIterator;
use Nata\Collection\Iterator\UnfoldIterator;
use Nata\Collection\Iterator\ZipIterator;
use Countable;
...
trait CollectionTrait
{
     ...
     * @return \Nata\Collection\CollectionInterface
     */
    ...
    public function countBy($path): CollectionInterface
    {
        ...
        $mapper = function ($value, $key, $mr) use ($callback): void {
            /** @var \Nata\Collection\Iterator\MapReduce $mr */
