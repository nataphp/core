 ...
 */
    protected static function _find($char, $type = 'lower') {
        ...
        if (!isset(self::$_codeRange[$char])) {
            ...
            if (!Configure::configured('_nata_core_')) {
                App::uses('PhpReader', 'Configure');
                Configure::config('_nata_core_', new PhpReader(CAKE . 'Config' . DS));
            }
            Configure::load('unicode' . DS . 'casefolding' . DS . $range, '_nata_core_');
 ...
 */
    public static function checkMultibyte($string): bool {
        return Text::checkMultibyte($string);
    }
