 ...
 */
    public function initialize($config = null) {
        $this->_mailer = new Mailer($config);
    }
 ...
 */
    public function __call($name, $args) {
        return call_user_func_array([$this->_mailer, $name], $args);
    }
 ...
 */
    public function __set($varName, $value) {
        return $this->_mailer->{$varName} = $value;
    }
