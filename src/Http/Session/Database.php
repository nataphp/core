...
/**
 * Http\Session\Database provides methods to be used with Session.
 */
...
/**
 * Whether or not the gc has been called to cleanup expired sessions.
 *
 * @var bool
 */
    protected static $_gc = false;

/**
 * Probability of garbage collection.
 * The numerator is the probability, the denominator is the divisor.
 *
 * @var int
 */
    protected $_gcProbability = 3;
 ...
 */
    public function gc($maxlifetime): bool {
        if (($this->_gcProbability === 100) || !(time() % (100 - $this->_gcProbability) !== 0)) {
