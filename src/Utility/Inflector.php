 ...
 * @return void
 */
    public static function rules(string $type, array $rules, $reset = false) {
        switch ($type) {
...
/**
 * Returns the given lower_case_and_underscored_word or lower-case-and-hifenated-word as a CamelCased word.
 *
 * @param string|null $lowerCaseAndUnderscoredWord Word to camelize
 * @return string|null Camelized word. LikeThis. Returns null if input was null.
 ...
 */
    public static function underscore($camelCasedWord) {
        $camelCasedWord = static::camelize($camelCasedWord);
...
/**
 * Returns the given camelCasedWord as an dashed-word.
 *
 * @param string|null $camelCasedWord Camel-cased word to be "dashed"
 * @return string|null Dashed-syntaxed version of the $camelCasedWord, or null if input was null
 */
    public static function dasherize(?string $camelCasedWord): ?string {
...
/**
 * Returns the given camelCasedWord as an hyphenated-word.
 *
 * @param string $camelCasedWord Camel-cased word to be "dashed"
 * @return string Dashed-syntaxed version of the $camelCasedWord
 * @deprecated Use Inflector::dasherize() instead
 */
    public static function hyphen($camelCasedWord) {
        return static::dasherize($camelCasedWord);
    }
 ...
 * @return string|null Human-readable string, or null if input was null
 ...
 * @param bool $lowercase SLug in lower case (defaults to true)
 * @return string
