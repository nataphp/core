...
use Nata\Controller\Controller as NataController;
 ...
 */
    public function __construct(Auth $auth, array $config = array()) {
        ...
        $this->controller($auth->getController());
    }
 ...
 * @throws \Nata\Core\Exception\Exception If controller does not have method `isAuthorized()`.
 */
    public function controller(NataController $controller = null) {
        if ($controller) {
