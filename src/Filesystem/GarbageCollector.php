 ...
 *
 * @var \Nata\Filesystem\Folder|string
 */
    protected $_folder;
 ...
 * Constructor.
 *
 * @param \Nata\Filesystem\Folder|string $folder Folder to garbage collect
 * @param array $options Options
 */
    public function __construct($folder, array $options = array()) {
        if (is_array($folder)) {
            $options = $folder;
            $folder = null;
        }
 ...
 * Set/get folder.
 *
 * @param \Nata\Filesystem\Folder|string $folder Folder to collect
 * @return \Nata\Filesystem\Folder|$this
 */
 ...
 * @return boolean True if we should execute, false otherwise
 */
    public static function run($path, $options = array(), $callback = null) {
 ...
 */
    public static function fetch($path, $options = array(), $callback = null) {
