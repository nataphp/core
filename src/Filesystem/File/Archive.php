 ...
 *
 * @var \Nata\Filesystem\File\ArchiveFormat\Base
 */
 ...
 *
 * @return \Nata\Filesystem\File\ArchiveFormat\Base Archive format adapter
 */
    protected function _loadFormatAdapter() {
        if ($this->_formatAdapter === null) {
            ...
            $className = App::className($class, 'Filesystem/File/ArchiveFormat');
            if (!$className) {
                $className = '\Nata\Filesystem\File\ArchiveFormat\Base';
            }
