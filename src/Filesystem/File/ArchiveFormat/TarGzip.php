 ...
 */
    public function extractTo($pathTo, $files, $overwrite) {
        ...
        $tarFilename = str_replace('.gz', '', $archiveFile->pwd());
        (new File($tarFilename))->delete();

        $gzip = new PharData($archiveFile->pwd());
 ...
 *
 * @param string|array $files File or array of files to extract
 * @return \Nata\Filesystem\File|array File or array of file instances
 */
 ...
 *
 * @param \Nata\Filesystem\File|string $file File or file path
