...
use Nata\Filesystem\File\Archive;
use Nata\Filesystem\File\ArchiveFormat\ArchivedFile\PharFile;
use PharData;
 ...
 * File archive.
 *
 * @var \Nata\Filesystem\File\Archive
 */
 ...
 *
 * @param \Nata\Filesystem\File\Archive $archiveFile Archive file instance
 * @return void
 */
 ...
 */
    public function getContents() {
        if ($this->_contents === null) {
            $this->_contents = $this->_getFilesRecursively($this->_archiveFile->pwd());
        }
