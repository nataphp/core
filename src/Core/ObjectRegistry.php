 ...
 * as a super class for various composition based re-use features in NataPHP.
 *
 ...
 */
abstract class ObjectRegistry implements Iterator {
 ...
 *
 * Using Nata\Controller\Controller::$components as an example. You can alias
 ...
 */
    public function exists($objectName) {
        ...
        $className = $this->_resolveClassName($objectName);
        return $className || (is_string($className) && class_exists($className));
    }
 ...
 */
    public function set($objectName, $object) {
        ...
        if (isset($this->_eventManager) && $object instanceof Listener) {
